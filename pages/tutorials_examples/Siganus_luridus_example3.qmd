...
| **Task**                            | **Execution Time**         |
|-------------------------------------|----------------------------|
| Loading input data                  | 1.84 secs                  |
| Processing P/A coordinates           | 0.01 secs                  |
| Processing covariate layers          | 1.05 secs                  |
| Building model matrix               | 1.20 secs                  |
| Fitting native range models         | 0.02 mins                  |
| Variable importance (native range)   | 0.00001 mins               |
| P/A cutoff (native range)            | 0.01 mins                  |
| Projections on fit layers (native range) | 0.40 mins              |
| Native range projections            | 0.39 mins                  |
| Native range                        | 0.82 mins                  |
| Fitting suitable habitat models     | 0.01 mins                  |
| Variable importance (suitable habitat) | 0.000007 mins            |
| P/A cutoff (suitable habitat)       | 0.01 mins                  |
| Projections on fit layers (suitable habitat) | 0.37 mins           |
| Suitable habitat projections        | 0.38 mins                  |
| Habitat suitability                 | 0.002 mins                 |
| Suitable habitat                    | 0.78 mins                  |
| Computing functional responses      | 0.70 mins                  |
| Cross-validation                    | 0.51 mins                  |
| Model summary                        | 0.03 mins                  |
| **Total GLOSSA analysis**           | **2.92 mins**              |
